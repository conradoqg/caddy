...
<p align="center">
	...
	<a href="https://godoc.org/github.com/conradoqg/caddy"><img src="https://img.shields.io/badge/godoc-reference-blue.svg"></a>
	<a href="https://goreportcard.com/report/mholt/caddy"><img src="https://goreportcard.com/badge/github.com/conradoqg/caddy"></a>
	<br>
	<a href="https://twitter.com/caddyserver" title="@caddyserver on Twitter"><img src="https://img.shields.io/badge/twitter-@caddyserver-55acee.svg" alt="@caddyserver on Twitter"></a>
	<a href="https://caddy.community" title="Caddy Forum"><img src="https://img.shields.io/badge/community-forum-ff69b4.svg" alt="Caddy Forum"></a>
	<a href="https://sourcegraph.com/github.com/conradoqg/caddy?badge" title="Caddy on Sourcegraph"><img src="https://sourcegraph.com/github.com/conradoqg/caddy/-/badge.svg" alt="Caddy on Sourcegraph"></a>
</p>
<p align="center">
...
Available for Windows, Mac, Linux, BSD, Solaris, and [Android](https://github.com/conradoqg/caddy/wiki/Running-Caddy-on-Android).
...
- **[Latest release](https://github.com/conradoqg/caddy/releases/latest)** for pre-built, vanilla binaries
...
- Get the source with `go get github.com/conradoqg/caddy/caddy` and then run `go get github.com/caddyserver/builds`
- Now `cd $GOPATH/src/github.com/conradoqg/caddy/caddy` and run `go run build.go`
...
**[Join our forum](https://caddy.community) where you can chat with other Caddy users and developers!** To get familiar with the code base, try [Caddy code search on Sourcegraph](https://sourcegraph.com/github.com/conradoqg/caddy/)!

Please see our [contributing guidelines](https://github.com/conradoqg/caddy/blob/master/.github/CONTRIBUTING.md) for instructions. If you want to write a plugin, check out the [developer wiki](https://github.com/conradoqg/caddy/wiki).
...
If you want to contribute to the documentation, please [submit an issue](https://github.com/conradoqg/caddy/issues/new) describing the change that should be made.
